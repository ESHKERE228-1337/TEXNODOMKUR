...
// Получение товаров из таблицы catalog для категории "Техника для уборки"
$stmt = $pdo->query("SELECT id, name, price, images FROM catalog WHERE category = 'Техника для уборки'");
...
<head>
    ...
    <title>Техно-Дом | Техника для уборки</title>
    ...
    <main>
        <div class="container">
            ...
            <aside class="filters">
                ...
                <div class="filter-section">
                    <h3>Тип уборки</h3>
                    <label><input type="checkbox" name="type" value="Сухая уборка"> Сухая уборка</label>
                    <label><input type="checkbox" name="type" value="Влажная уборка"> Влажная уборка</label>
                    <label><input type="checkbox" name="type" value="Мойка полов"> Мойка полов</label>
                </div>
                <div class="filter-section">
                    <h3>Тип пылесоса</h3>
                    <label><input type="checkbox" name="vacuum_type" value="Робот-пылесос"> Робот-пылесос</label>
                    <label><input type="checkbox" name="vacuum_type" value="Вертикальный пылесос"> Вертикальный пылесос</label>
                    <label><input type="checkbox" name="vacuum_type" value="Моющий пылесос"> Моющий пылесос</label>
                </div>
                <div class="filter-section">
                    <h3>Мощность</h3>
                    <label><input type="checkbox" name="power" value="До 100 Вт"> До 100 Вт</label>
                    <label><input type="checkbox" name="power" value="100-200 Вт"> 100-200 Вт</label>
                    <label><input type="checkbox" name="power" value="Более 200 Вт"> Более 200 Вт</label>
                </div>
            </aside>
