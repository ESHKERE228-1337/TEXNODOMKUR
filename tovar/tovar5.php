...
// Получение товаров из таблицы catalog для категории "Ноутбуки"
$stmt = $pdo->query("SELECT id, name, price, images FROM catalog WHERE category = 'Ноутбуки'");
...
<head>
    ...
    <title>Техно-Дом | Ноутбуки</title>
        ...
        <div class="container">
            ...
            <aside class="filters">
                ...
                <div class="filter-section">
                    ...
                    <label><input type="checkbox" name="processor" value="AMD Ryzen 7"> AMD Ryzen 7</label>
                </div>
                <div class="filter-section">
                    <h3>Оперативная память</h3>
                    <label><input type="checkbox" name="ram" value="8 ГБ"> 8 ГБ</label>
                    <label><input type="checkbox" name="ram" value="16 ГБ"> 16 ГБ</label>
                    <label><input type="checkbox" name="ram" value="32 ГБ"> 32 ГБ</label>
                </div>
                <div class="filter-section">
                    <h3>Диагональ экрана</h3>
                    <label><input type="checkbox" name="screen_size" value="13 дюймов"> 13 дюймов</label>
                    <label><input type="checkbox" name="screen_size" value="15 дюймов"> 15 дюймов</label>
                    <label><input type="checkbox" name="screen_size" value="17 дюймов"> 17 дюймов</label>
                </div>
            </aside>
