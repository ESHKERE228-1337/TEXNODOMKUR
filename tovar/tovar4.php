...
// Получение товаров из таблицы catalog для категории "Компьютеры"
$stmt = $pdo->query("SELECT id, name, price, images FROM catalog WHERE category = 'Компьютеры'");
...
<head>
    ...
    <title>Техно-Дом | Компьютеры</title>
    ...
    <main>
        <div class="container">
            ...
            <aside class="filters">
                ...
                <div class="filter-section">
                    <h3>Тип компьютера</h3>
                    <label><input type="checkbox" name="type" value="Ноутбук"> Ноутбук</label>
                    <label><input type="checkbox" name="type" value="Настольный ПК"> Настольный ПК</label>
                    <label><input type="checkbox" name="type" value="Моноблок"> Моноблок</label>
                </div>
                <div class="filter-section">
                    <h3>Процессор</h3>
